...
<?php
 $ts_photography_shop_page_sidebar = get_theme_mod( 'ts_photography_shop_page_sidebar',true );
 if ( false == $ts_photography_shop_page_sidebar ) {
...
<div class="container">
	<main role="main" id="maincontent">
		<div class="row">
			...
			<?php if ( false != $ts_photography_shop_page_sidebar ) {?>
