...
<body <?php body_class(); ?>>
  ...
  <div class="<?php if( get_theme_mod( 'ts_photography_sticky_header', false) != '' || get_theme_mod( 'ts_photography_responsive_sticky_header', false) != '') { ?> sticky-header"<?php } else { ?>close-sticky <?php } ?>">
    <header role="banner">
      <?php if(get_theme_mod('ts_photography_preloader_option',true) != '' || get_theme_mod('ts_photography_responsive_preloader', true) != ''){ ?>
            ...
            <div class="row">
              <div class="logo col-lg-3 col-md-9 col-9">
                ...
                <?php if ( ! empty( $blog_info ) ) : ?>
                  <?php if( get_theme_mod('ts_photography_site_title',true) != ''){ ?>
                ...
                if ( $description || is_customize_preview() ) :
                  ?>
                  <?php if( get_theme_mod('ts_photography_tagline',true) != ''){ ?>
              ...
              <div class="col-lg-8 col-md-3 col-3 padremove">
                <?php 
                  ...
                  <div class="toggle-menu responsive-menu">
                    <button class="mobiletoggle"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','ts-photography'); ?></span></button>
                  </div>
                <?php }?>
                <div id="menu-sidebar" class="nav sidebar">
                  <nav id="primary-site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'ts-photography' ); ?>">
                    ...
                    <a href="javascript:void(0)" class="closebtn responsive-menu"><i class="far fa-times-circle"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','ts-photography'); ?></span></a>
                  </nav>
                </div>
              </div>
